# Generated by Django 5.1.2 on 2025-05-08 07:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_llm_models', models.ManyToManyField(blank=True, help_text='Which LLMs this user has favorited', related_name='favored_by', to='app.llmmodel')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['changed_at'], name='app_documen_changed_a05fe9_idx'),
        ),
    ]
